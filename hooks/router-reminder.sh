...
complexity and pick a track (T0 trivial → T3 full workflow) per AGENTS.md. Announce it
in one line. Bias heavier when unsure. Keep TDD for behavior changes; use dry-run or
