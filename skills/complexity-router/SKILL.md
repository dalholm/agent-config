...
**TDD** for behavior-bearing code changes (failing test first) and a final self-review
— even on T1 when code behavior changes. For documentation, prompt, copy, wiring, or
...
| "Skip the test, it's tiny" | If code behavior changes, TDD is a quality gate, not ceremony. Keep it. |
