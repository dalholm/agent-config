...
export const WORKFLOW_TOOL_DESCRIPTION = [
  ...
  "phase('Scan')",
  "const scans = await parallel(args.files.map((f) => () => agent(`Inspect ${f} and report correctness and reliability risks.`, { label: `scan:${f}`, phase: 'Scan', role: 'researcher', tier: 'standard', schema: FINDINGS })))",
...
export const WORKFLOW_PROMPT_GUIDELINES = [
  ...
  "Do not assign scout or reviewer inside an in-process workflow. Local scout work and independent review must use subagent_spawn with the appropriate provenance.",
];
